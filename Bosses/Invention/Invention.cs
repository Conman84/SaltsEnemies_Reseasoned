...
namespace SaltsEnemies_Reseasoned
{
    public static class Invention
    {
        public static void Add()
        {
            ...
            TargetingUnit_NotManuallyAbility targeting_ability = ScriptableObject.CreateInstance<TargetingUnit_NotManuallyAbility>();
            ...
            Effects.GenerateEffect(randomize, 3, Slots.Self, ScriptableObject.CreateInstance<EverybodyAbilityCondition>())];
            ...
            Effects.GenerateEffect(randomize, 3, Slots.Self, ScriptableObject.CreateInstance<EverybodyMovedCondition>())];
