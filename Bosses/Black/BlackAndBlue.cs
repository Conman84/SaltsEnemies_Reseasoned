...
namespace SaltsEnemies_Reseasoned
{
    public static class BlackAndBlue
    {
        public static void Add()
        {
            ...
            template.PrepareEnemyPrefab("Assets/Bosses/BB/BlackAndBlue_Enemy.prefab", SaltsReseasoned.Meow, SaltsReseasoned.Meow.LoadAsset<GameObject>("Assets/Bosses/BB/BlackAndBlue_Gibs.prefab").GetComponent<ParticleSystem>());
            ...
            bb.Effects[0] = Effects.GenerateEffect(ScriptableObject.CreateInstance<DamageEffect>(), 4, Slots.Front);
            ...
            cc.Rarity = Rarity.CreateAndAddCustomRarityToPool("bb65", 65);
            cc.Effects = [
