...
namespace SaltEnemies_Reseasoned
{
    public static class Muted
    {
        ...
        public static void Add()
        {
            ...
            Debug.LogError("Muted.Add. put the right sprite here");
            LeftInfo._statusName = "Muted";
            LeftInfo._description = "Get the description";
            Debug.LogError("Muted.Add. get the status description");
            ...
            Debug.LogError("Muted.Add. set the right sprite for the intent also");
