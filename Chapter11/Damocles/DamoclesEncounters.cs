...
namespace SaltsEnemies_Reseasoned
{
    public static class DamoclesEncounters
    {
        public static void Add()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Garden.H.Damocles.Easy, April.Birthday ? 10 : April.Custom ? 3 : 0, ZoneType_GameIDs.Garden_Hard, BundleDifficulty.Easy);
