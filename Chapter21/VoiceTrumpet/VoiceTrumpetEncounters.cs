...
namespace SaltsEnemies_Reseasoned
{
    public static class VoiceTrumpetEncounters
    {
        ...
        public static void Add_Easy()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Shore.H.Trumpet.Easy, 4, ZoneType_GameIDs.FarShore_Hard, BundleDifficulty.Easy);
        }
        public static void Add_Med()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Shore.H.Trumpet.Med, 8, ZoneType_GameIDs.FarShore_Hard, BundleDifficulty.Medium);
        }
