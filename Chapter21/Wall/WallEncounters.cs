...
namespace SaltsEnemies_Reseasoned
{
    public static class WallEncounters
    {
        ...
        public static void Add_Med_Normal()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Shore.Wall.Med, 11, ZoneType_GameIDs.FarShore_Easy, BundleDifficulty.Medium);
        }
        public static void Add_Easy_Hardmode()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Shore.H.Wall.Easy, 3, ZoneType_GameIDs.FarShore_Hard, BundleDifficulty.Easy);
        }
        public static void Add_Med_Hardmode()
        {
            ...
            med.AddEncounterToDataBases();
            EnemyEncounterUtils.AddEncounterToZoneSelector(Shore.H.Wall.Med, 8, ZoneType_GameIDs.FarShore_Hard, BundleDifficulty.Medium);
        }
