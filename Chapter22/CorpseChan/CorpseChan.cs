...
namespace SaltsEnemies_Reseasoned
{
    public static class CorpseChan
    {
        public static void Add()
        {
            ...
            homunculus._triggerOn = [TriggerCalls.OnPlayerTurnEnd_ForEnemy, TriggerCalls.OnAbilityUsed, StarlessPassiveAbility.Call, TriggerCalls.AttacksPerTurn];
