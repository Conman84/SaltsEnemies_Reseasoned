...
namespace SaltsEnemies_Reseasoned.Chapter1.LostSheep
{
    public static class LostSheepEncounters
    {
        ...
        public static void Add2()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Shore.H.CNS.Easy, April.Birthday ? April.LessMod : April.Custom ? 1 : 0, ZoneType_GameIDs.FarShore_Hard, BundleDifficulty.Easy);
        }
    }
}