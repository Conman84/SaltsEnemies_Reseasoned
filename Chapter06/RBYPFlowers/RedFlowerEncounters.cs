...
namespace SaltsEnemies_Reseasoned
{
    public static class RedFlowerEncounters
    {
        public static void Add()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector("H_Zone03_RedFlower_Easy_EnemyBundle", 5, ZoneType_GameIDs.Garden_Hard, BundleDifficulty.Easy);
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector("H_Zone03_RedFlower_Medium_EnemyBundle", 5, ZoneType_GameIDs.Garden_Hard, BundleDifficulty.Medium);
