    ...
    public static class War
    {
        public static void Add()
        {
            Enemy template = new Enemy("War", "War_EN")
            {
                ...
                OverworldDeadSprite = ResourceLoader.LoadSprite("WarWorld.png", new Vector2(0.5f, 0f), 32),
                OverworldAliveSprite = ResourceLoader.LoadSprite("WarDead.png", new Vector2(0.5f, 0f), 32),
