    ...
    public static class NobodyGrave
    {
        public static void Add()
        {
            Enemy grave = new Enemy("Nobody's Grave", "NobodyGrave_EN")
            {
                ...
                OverworldAliveSprite = ResourceLoader.LoadSprite("GraveWorld.png", new Vector2(0.5f, 0f), 32),
                OverworldDeadSprite = ResourceLoader.LoadSprite("GraveDead.png", new Vector2(0.5f, 0f), 32),
            ...
            des._enemyDescription = "If this enemy has 12 or less health, it will perform an extra ability \"Desecration\" each turn.";
