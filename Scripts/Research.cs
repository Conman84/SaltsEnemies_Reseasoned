...
namespace SaltsEnemies_Reseasoned
{
    public static class Research
    {
        ...
        public static void PrintPassives()
        {
            ...
            //Debug.Log(PassiveType_GameIDs.Parental.ToString());
            Debug.Log(Passives.Unstable.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Unstable.ToString());
            Debug.Log(Passives.Constricting.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Constricting.ToString());
            Debug.Log(Passives.Formless.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Formless.ToString());
            ...
            //Debug.Log(PassiveType_GameIDs.Withering.ToString());
            Debug.Log(Passives.Overexert1.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Overexert.ToString());
            Debug.Log(Passives.MultiAttack2.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.MultiAttack.ToString());
            Debug.Log(Passives.Obscure.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Obscure.ToString());
            Debug.Log(Passives.Confusion.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Confusion.ToString());
            Debug.Log(Passives.Fleeting3.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Fleeting.ToString());
            Debug.Log(Passives.Dying.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Dying.ToString());
            Debug.Log(Passives.Inanimate.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Inanimate.ToString());
            Debug.Log(Passives.Inferno.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Inferno.ToString());
            Debug.Log(Passives.Enfeebled.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Enfeebled.ToString());
            Debug.Log(Passives.Immortal.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Immortal.ToString());
            Debug.Log(Passives.TwoFaced.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.TwoFaced.ToString());
            Debug.Log(Passives.Catalyst.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Catalyst.ToString());
            Debug.Log(Passives.Anchored.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Anchored.ToString());
            Debug.Log(Passives.Delicate.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Delicate.ToString());
            Debug.Log(Passives.Leaky1.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Leaky.ToString());
            Debug.Log(Passives.PanicAttack.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.PanicAttack.ToString());
            Debug.Log(Passives.Transfusion.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Transfusion.ToString());
            Debug.Log(Passives.Abomination1.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Abomination.ToString());
            Debug.Log(Passives.BoneSpurs1.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.BoneSpurs.ToString());
            Debug.Log(Passives.Masochism1.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Masochism.ToString());
            Debug.Log(Passives.Construct.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Construct.ToString());
            Debug.Log(Passives.Cashout.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Cashout.ToString());
            Debug.Log(Passives.Infestation1.m_PassiveID);
            //Debug.Log(PassiveType_GameIDs.Infestation.ToString());
        }
