...
namespace SaltEnemies_Reseasoned
{
    public static class PostLoading
    {
        ...
        {
            IDetour addThingsToSepulchreAndBronzoIDetour = (IDetour)new Hook((MethodBase)typeof(MainMenuController).GetMethod(nameof(MainMenuController.LoadLanguage), ~BindingFlags.Default), typeof(PostLoading).GetMethod(nameof(ProcessGameStart), ~BindingFlags.Default));
        ...
        public static void ProcessGameStart(Action<MainMenuController> orig, MainMenuController self)
        {
            ...
            PCall(AApocrypha_Set3Crossovers.Add);
