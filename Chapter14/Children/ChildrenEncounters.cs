...
namespace SaltsEnemies_Reseasoned
{
    public static class ChildrenEncounters
    {
        public static void Add()
        {
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector(Garden.H.Children.Easy, April.Birthday ? 2 : April.Custom ? 1 : 0, ZoneType_GameIDs.Garden_Hard, BundleDifficulty.Easy);
        }
