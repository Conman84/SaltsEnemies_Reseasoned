...
namespace SaltsEnemies_Reseasoned
{
    public static class WolfColony
    {
        public static void Add()
        {
            ...
            tickler.Description = "Heal all enemies 2 Health.\nIf the total amount of healing dealt is less than 3, deal an Agonizing amount of damage to the Opposing enemy.";
            ...
            tickler.Effects = [
                ...
                Effects.GenerateEffect(BasicEffects.GetVisuals("Salt/Anchoring", false, Slots.Front), 1, Slots.Self, BasicEffects.DidThat(false)),
            ...
            tickler.AddIntentsToTarget(Slots.Front, ["Misc_Hidden", "Damage_7_10"]);
            ...
            tomure.Name = "Tomure";
            tomure.Description = "Slightly heal the Lowest health enemy.\nIf no healing is dealt, deal a Painful amount of damage to the Opposing party member. Otherwise, Curse this enemy.";
            ...
            tomure.Effects = [
                ...
                Effects.GenerateEffect(ScriptableObject.CreateInstance<DamageEffect>(), 5, Slots.Front, BasicEffects.DidThat(true)),
                ];
