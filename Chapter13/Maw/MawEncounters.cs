...
namespace SaltsEnemies_Reseasoned
{
    public static class MawEncounters
    {
        ...
        public static void Add_Med()
        {
            ...
            med.AddRandomEncounter("Maw_EN", "WindSong_EN", "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", Enemies.Solvent, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", "Something_EN");
            med.AddRandomEncounter("Maw_EN", Flower.Purple, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", Flower.Yellow, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", Spoggle.Red, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", Spoggle.Purple, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", Jumble.Blue, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", Jumble.Purple, "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", "Nameless_EN", "MusicMan_EN");
            med.SimpleAddEncounter(1, "Maw_EN", 4, "SingingStone_EN");
            med.AddRandomEncounter("Maw_EN", "Delusion_EN", "Delusion_EN");
            med.AddRandomEncounter("Maw_EN", "MusicMan_EN", "MusicMan_EN");
            med.AddRandomEncounter("Maw_EN", "Sigil_EN");
            med.AddRandomEncounter("Maw_EN", "LostSheep_EN");
            med.AddRandomEncounter("Maw_EN", "Enigma_EN", "Enigma_EN");
            med.AddRandomEncounter("Maw_EN", "Scrungie_EN");
            med.AddRandomEncounter("Maw_EN", Enemies.Camera, Enemies.Camera);
            med.AddRandomEncounter("Maw_EN", "Spectre_EN", "Spectre_EN", "Spectre_EN");
            med.AddRandomEncounter("Maw_EN", "Rabies_EN", Enemies.Suckle, Enemies.Suckle);
