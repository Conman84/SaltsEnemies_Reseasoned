...
namespace SaltsEnemies_Reseasoned
{
    public static class Maw
    {
        public static void Add()
        {
            ...
            bad._enemyDescription = "At the start of each round and on anything moving during the player's turn, if this enemy has an Opposing party member, remove all of its actions from the timeline. \nOtherwise, return all lost actions.";
            ...
            skinning._enemyDescription = "On being directly damaged, spawn as many Visuals as possible.";
            skinning._characterDescription = "dude... idk";
            skinning.doesPassiveTriggerInformationPanel = true;
            skinning.effects = [
                    Effects.GenerateEffect(spawn, 5)
                ];
